...
* Clique fora da imagem perde uma vida, o número de vidas são 3 e esta indicado no canto superior direito;
* O jogo termina ao esgotar tempo de 60 segundos ou quando zerar as vidas, então uma mensagem será apresentada com número de acertos;
* Clique no botão OK o jogo será reiniciado.

*Todos os créditos à equipe DIO.*